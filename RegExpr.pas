...
const
 NSUBEXP = 10{15}; // max number of subexpression //###0.929
 ...
 MaxBracesArg = 10000{ $7FFFFFFF - 1}; // max value for {n,m} arguments //###0.933

 {$IFDEF ComplexBraces}
 LoopStackMax = 5{10}; // max depth of loops stack //###0.925
 {$ENDIF}
